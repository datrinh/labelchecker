(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('@angular/cdk/layout'), require('rxjs'), require('@angular/material'), require('@angular/animations'), require('@angular/forms'), require('@angular/core'), require('rxjs/operators'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('gamifilearning-lib', ['exports', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/cdk/layout', 'rxjs', '@angular/material', '@angular/animations', '@angular/forms', '@angular/core', 'rxjs/operators', '@angular/common/http'], factory) :
    (factory((global['gamifilearning-lib'] = {}),global.ng.platformBrowser,global.ng.platformBrowser.animations,global.ng.cdk.layout,global.rxjs,global.ng.material,global.ng.animations,global.ng.forms,global.ng.core,global.rxjs.operators,global.ng.common.http));
}(this, (function (exports,platformBrowser,animations,layout,rxjs,material,animations$1,forms,i0,operators,i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var QuestionService = /** @class */ (function () {
        function QuestionService() {
            this.data = [];
            this.currentInstance = new rxjs.BehaviorSubject(null);
            this.currentInstance$ = this.currentInstance.asObservable();
            this.answers = new rxjs.BehaviorSubject([]);
    ...
    var GamificationService = /** @class */ (function () {
        function GamificationService(http) {
            var _this = this;
            this.http = http;
            this.score = new rxjs.BehaviorSubject(0);
         ...
         */
            function (query) {
                ...
                operators.map(function (gif) { return _this.getRandomElement(gif.data); }));
            };
        ...
        GamificationService.prototype.doIncreaseScore =
             ...
             */
            function (weight) {
                return rxjs.of(this.score.value + Math.floor(weight * 100));
            };
        ...
        /** @nocollapse */
        GamificationService.ctorParameters = function () {
            return [
                { type: i1.HttpClient }
            ];
        };
     ...
     */
    /** @type {?} */
    var pulseAnimation = animations$1.animation([
        animations$1.style({ transform: 'scale(1)' }),
        animations$1.animate('{{ timings }}', animations$1.keyframes([
            animations$1.style({ transform: 'scale(1)', offset: 0 }),
            animations$1.style({ transform: 'scale({{ scale }})', offset: 0.5 }),
            animations$1.style({ transform: 'scale(1)', offset: 1 })
        ]))
    ]);
    ...
    var RewardDialogComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        RewardDialogComponent.ctorParameters = function () {
            return [
    ...
    var QuestionRoomComponent = /** @class */ (function () {
        ...
        QuestionRoomComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        animations: [
                            animations$1.trigger('fadeIn', [
                                animations$1.transition(':increment', [
                                    animations$1.animate('500ms', animations$1.keyframes([
                            ...
                            animations$1.trigger('unlockReward', [
                                animations$1.transition('false => true', [
                                    animations$1.useAnimation(pulseAnimation, {
                                        params: {
        ...
        /** @nocollapse */
        QuestionRoomComponent.ctorParameters = function () {
            return [
        ...
        QuestionRoomComponent.propDecorators = {
            maxProgress: [{ type: i0.Input }],
            done: [{ type: i0.Input }],
            currentInstance: [{ type: i0.Input }],
            rewards: [{ type: i0.Input }],
            questions: [{ type: i0.Input }],
            answers: [{ type: i0.Input }],
            showProgressbar: [{ type: i0.Input }],
            answerMode: [{ type: i0.Input }],
            selection: [{ type: i0.ViewChild, args: ['selectionList',] }]
        };
    ...
    var ScoreDisplayComponent = /** @class */ (function () {
        ...
        ScoreDisplayComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        animations: [
                            animations$1.trigger('scoreChange', [
                                animations$1.transition(':increment', animations$1.useAnimation(pulseAnimation, {
                                    params: {
                                        timings: '400ms cubic-bezier(.11,.99,.83,.43)',
                                        scale: 1.25
                                    }
        ...
        /** @nocollapse */
        ScoreDisplayComponent.ctorParameters = function () {
            return [
                { type: GamificationService }
            ];
        };
    ...
    var CommunicationService = /** @class */ (function () {
         ...
         */
            function (src) {
                ...
                return this.http
                    .get(URL_TO_DATA)
                    .pipe(operators.map(function (res) { return _this.enhanceFeatures(res); }));
            };
    ...
    exports.QuestionRoomComponent = QuestionRoomComponent;
    ...
    exports.ɵb = RewardDialogComponent;
    exports.ɵa = pulseAnimation;
    exports.ɵc = TranslatePipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gamifilearning-lib.umd.js.map